...
async function loadPokemon(id) {
  try {
    ...
    if (currentPokemonId === id) {
      ...
      window.history.pushState({}, "", `./detalle.html?id=${id}`);
    }
...
function displayPokemonDetails(pokemon) {
  ...
  const sprite = document.querySelector(".sprite-wrapper img");
  sprite.src = `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/showdown/${id}.gif`;
  sprite.alt = name;
